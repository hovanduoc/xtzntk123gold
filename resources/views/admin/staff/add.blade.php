                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5"><input type="text" name="hoten" id="hoten" class="form-control" value="{!! old('hoten') !!}" placeholder="Họ Và Tên"></div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label" style=" text-align: left; ">Ngày Sinh</label>
                            <div class="col-sm-5"><input type="text" name="ngaysinh" id="ngaysinh" class="form-control" value="{!! old('ngaysinh') !!}" placeholder="Ngày Sinh (VD : 30-05-1993)"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control input-sm" id="gioitinh" name="gioitinh">
                                    <option value="{{ old('gioitinh') }}">Chọn Giới Tính</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5"><input type="text" name="diachi" id="diachi" class="form-control" value="{!! old('diachi') !!}" placeholder="Họ Và Tên"></div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label" style=" text-align: left; ">Email</label>
                            <div class="col-sm-5"><input type="text" name="email" id="email" class="form-control" value="{!! old('email') !!}" placeholder="Email (VD : hovanduoc@gmail.com)"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5"><input type="text" name="sdt" id="sdt" class="form-control" value="{!! old('sdt') !!}" placeholder="Số Điện Thoại"></div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label" style=" text-align: left; ">Mật Khẩu</label>
                            <div class="col-sm-5"><input type="password" name="matkhau" id="matkhau" class="form-control" value="{!! old('matkhau') !!}" placeholder="Mật Khẩu"></div>
                        </div>
			 <div class="form-group">
				...
				@foreach($province as $item)
				   <div class="col-md-4 col-sm-4">
				   	<input type="checkbox" name="power[]" value="{{ $item->id }}">{{ $item->name }}
				   </div>
				@endforeach
 			    </div>
                        </div>
